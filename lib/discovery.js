...
function issuersMatch(configuredIssuer, discoveredIssuer) {
	return trimIssuer(configuredIssuer) === trimIssuer(discoveredIssuer);
}
...
async function discover(issuer) {
	...
	if (!issuersMatch(normalizedIssuer, metadata.issuer)) {
...
module.exports = { discover, discoveryUrl, issuersMatch, trimIssuer };
